...
void Renderer::createSwapChain() {
    ...
    //std::cout << "Image Extent = " << createInfo.imageExtent.width << " " << createInfo.imageExtent.height << "\n";
...
VkExtent2D Renderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
    ...
    //else {
    //    int width, height;
    //    glfwGetFramebufferSize(window, &width, &height); //more window pointer bullshit
